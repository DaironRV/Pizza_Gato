...
if respuesta == "si":
    ...
    respuesta_dinero = input(
        "tienes el dinero para las las cosas del gato? si/no")
...
respuesta = print(
    " ¿ donde vas a adopatr a el gato? (1)refugio/2)persona del comun)")
if respuesta == "1":
    print("genial! ahora los pasos a seguir para el fin de la adopcion",
          "paso 1: ir al refugio", "paso 2: encontrar al gato", "paso 3: frrmar los papeles")
elif respuesta == "2":
    print("Con una persona del comun, que bien. Ahora los pasos que faltan",
          "paso 1: ir al refugio", "paso 2: encontrar al gato", "paso 3: frrmar los papeles")
else:
